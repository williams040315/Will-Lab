...
if __name__ == "__main__":
    ...
    if normalImg == False:
        ...
        for c in cnts:
            ...
            caracteristics_img['Calcul']['Cell-'+str(elem)] = {}
            caracteristics_img['Calcul']['Cell-'+str(elem)]['barycenter'] = {}
            caracteristics_img['Calcul']['Cell-'+str(elem)]['barycenter']['x'] = cX
            caracteristics_img['Calcul']['Cell-'+str(elem)]['barycenter']['y'] = cY
            caracteristics_img['Calcul']['Cell-'+str(elem)]['geometry'] =  {}
            caracteristics_img['Calcul']['Cell-'+str(elem)]['geometry']['area'] =  area
            caracteristics_img['Calcul']['Cell-'+str(elem)]['geometry']['perimeter'] =  perimeter
            caracteristics_img['Calcul']['Cell-'+str(elem)]['meanIntensity'] = mean_val[0]
